...
| 03 | Fluxo completo da OS | 🚧 UI parcial, ações faltam | 00c, 01, 02 | 4–6 | 🔴 Alta |
| 04 | Clientes | 📅 | 00c, 03 | 2–3 | 🟡 Média |
| 05 | Logística (Maps) | 📅 | 03, 04 | 3–5 | 🟡 Média |
| 06 | Estoque | 📅 | 00c, 03 | 3–5 | 🟡 Média |
| 07 | Financeiro completo | 📅 (precisa schema parte 2) | 03, 06 | 5–7 | 🟡 Média |
| 08 | Relatórios com IA | 📅 | 03, 06, 07 | 4–6 | 🟢 Baixa |
...
### ❌ O que FALTA fazer (ações de cada etapa)
- ❌ **Pré-diagnóstico** (etapa Recebido) — formulário inexistente
- ❌ **Diagnóstico técnico** (etapa Diagnóstico) — formulário inexistente
- ❌ **Orçamento editável** (etapa Orçamento) — adicionar/remover/editar itens, desconto bidirecional
- ❌ **Botões Aprovar / Recusar orçamento**
- ❌ **Checklists de Limpeza e Manutenção** — hoje só mostra status, não permite editar
- ❌ **Teste final**: registro de falhas (volta pra "Em oficina" se houver)
- ❌ **Entrega**: confirmar entrega + foto opcional
- ❌ **Pagamento**: registrar formas de pagamento (PIX/Cartão/Misto/Parcelado), gerar link InfinitePay, criar lançamentos financeiros
- ❌ **Conclusão**: gerar resumo final
- ❌ **Abrir OS de garantia** (botão dentro da OS original concluída)
- ❌ **Conversão de Recusada pra Fabricação**
- ❌ **Recusada → Entrega → Pagamento** (com decisão de cobrar taxa de diagnóstico)
- ❌ **Baixa automática no estoque** ao usar peças
- ❌ **Entrada automática no estoque** ao concluir Fabricação
- ❌ **Reabertura de OS Concluída** (ação explícita)
...
> Status: 📅 · Prioridade: 🟡 Média · Estima: 5–7 chats
